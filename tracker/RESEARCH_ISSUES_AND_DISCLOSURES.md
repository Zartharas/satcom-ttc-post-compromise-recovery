...
| RIT-009 | ENHANCEMENT | MEDIUM | IN_PROGRESS | 15 | Project lacked a consolidated publication-readiness tracker. | Added Phase 15 tracker; status integration and validation still required. |
| RIT-010 | ENHANCEMENT | MEDIUM | IN_PROGRESS | 15 | Project lacked a consolidated engineering issue and disclosure register. | This file establishes the register and responsible-disclosure workflow. |
